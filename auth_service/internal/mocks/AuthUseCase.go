...
// Login provides a mock function with given fields: ctx, login, pass
func (_m *AuthUseCase) Login(ctx context.Context, login string, pass string) (string, string, string, error) {
...
// Register provides a mock function with given fields: ctx, login, pass
func (_m *AuthUseCase) Register(ctx context.Context, login string, pass string) (string, error) {
	ret := _m.Called(ctx, login, pass)
